...
public enum Circuit {
    ...
    SILVERSTONE("Silverstone", new Temps(0,32,760)),
    ...
    private Circuit(String desc, Temps pit){
        this.desc = desc;
        this.pit = pit;
    }
